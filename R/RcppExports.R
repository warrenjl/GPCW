...
GPCW <- function(mcmc_samples, y, x, z, metrop_var_phi_trans, likelihood_indicator, a_sigma2_epsilon_prior = NULL, b_sigma2_epsilon_prior = NULL, sigma2_beta_prior = NULL, a_sigma2_theta_prior = NULL, b_sigma2_theta_prior = NULL, a_phi_prior = NULL, b_phi_prior = NULL, sigma2_epsilon_init = NULL, beta_init = NULL, theta_init = NULL, sigma2_theta_init = NULL, phi_init = NULL) {
    .Call(`_GPCW_GPCW`, mcmc_samples, y, x, z, metrop_var_phi_trans, likelihood_indicator, a_sigma2_epsilon_prior, b_sigma2_epsilon_prior, sigma2_beta_prior, a_sigma2_theta_prior, b_sigma2_theta_prior, a_phi_prior, b_phi_prior, sigma2_epsilon_init, beta_init, theta_init, sigma2_theta_init, phi_init)
}
...
neg_two_loglike_update <- function(y, x, z, likelihood_indicator, sigma2_epsilon, beta, theta) {
